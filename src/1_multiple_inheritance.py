"""A module which reproduce the Kadet's dump() issue with multiple inheritance classes."""
...
class SpecTemplate(BaseObj):
    """Defines common spec.template interface."""
...
class Deployment(NamespacedObj, SpecTemplate):
...
def main():
    """Attempt to demonstrate suspected Kadet recursive dump() issue."""
    main_obj = BaseObj()
